...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x10000000 + 0x0), LENGTH = (1024 * 1024 - 0x0 - 0x0)
    RAM (wx) : ORIGIN = 0x30000000, LENGTH = (192 * 1K)
    SRAM1 ( rw ) : ORIGIN = (335544320), LENGTH = (98304)
...
noinit (NOLOAD) :
{
    ...
    __kernel_ram_end = 0x30000000 + (192 * 1K);
